...
const byte commandNames[] = "angry#happy#move#turn#arc#delay#colour#color#pixel#set#if#do#while#intime#endif#forever#endwhile#sound#until#clear#run#background#else#red#green#blue#yellow#magenta#cyan#white#black#wait#stop#begin#end#print#println#break#duration#continue#angle#"; // don't forget the # on the end
...
const byte happyCommand[] PROGMEM = "PF1";
...
const byte completeAwaitCommand[] PROGMEM = "CA";
...
const byte largeLimitValue[] PROGMEM = "20000";
...
const byte moveCommand[] PROGMEM = "MF";
...
const byte turnCommand[] PROGMEM = "MR";
...
const byte arcCommand[] PROGMEM = "MA";
...
const byte delayCommand[] PROGMEM = "CD";
...
const byte colourCommand[] PROGMEM = "PC";
...
const byte namedColourCommand[] PROGMEM = "PN";
...
const byte soundCommand[] PROGMEM = "ST";
const byte defaultSoundDuration[] PROGMEM = "500";
...
const byte setCommand[] PROGMEM = "VS";
...
const byte labelCommand[] PROGMEM = "CLl";
...
const byte jumpCommand[] PROGMEM = "CJl";
...
const byte endCommandText[] PROGMEM = "RX";

const byte failedCommandText[] PROGMEM = "RA";
...
const byte clearVariablesCommand[] PROGMEM = "VC";
...
const byte runCommand[] PROGMEM = "RS";
...
const byte waitCommand[] PROGMEM = "CA";
...
const byte stopCommand[] PROGMEM = "RH";
...
const byte clearCommand[] PROGMEM = "RC";
const byte beginCommand[] PROGMEM = "RM";
...
const byte newlineCommand[] PROGMEM = "WL";
